    ...
    <footer className="bg-gray-900 text-white py-10">
      <div className="container mx-auto flex flex-col md:flex-row justify-start items-start px-4 md:px-15 lg:px-100 space-y-8 md:space-y-0">
        <div className="w-full md:w-2/4 space-x-4 flex flex-col md:flex-row items-start md:items-center mb-8 md:mb-0">
          ...
          <div>
            ...
            <p className="text-gray-400 text-md mb-4">This website provides a platform for users to predict
               their likelihood of developing diabetes based on various factors..</p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0 md:px-10 lg:px-50">
          ...
          <div className="flex items-center text-gray-400 text-lg mb-4">
            ...
            <a href="deepand@gmail.com" className="text-gray-400 hover:text-white transition-colors duration-300 cursor-pointer">deepand@gmail.com</a>
          </div>
          <div className="flex items-center text-gray-400 text-lg">
            <FaPhone className="mr-2" />
            <a href="tel:123456789" className="text-gray-400 hover:text-white transition-colors duration-300 cursor-pointer">+1234567890</a>
          </div>
        </div>
      ...
      <div className="border-t border-gray-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center px-6 md:px-12 lg:px-20">
        <div className="text-gray-400 text-center md:text-left mb-4 md:mb-0">
          <p>&copy; 2025 Diabetes Prediction</p>
        </div>
        <div>
          <a
            href=""
          ...
          >
            <p>DEVELOPED BY DEEPAN CHAKARAVARTHY.P</p>
          </a>
        </div>
      </div>
    </footer>
