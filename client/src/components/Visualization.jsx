...
const VisualizationPage = () => {
  ...
  return (
    <div className="container mx-auto py-10 text-center bg-green-15">
      <motion.h1
        ...
        className="text-3xl font-bold mb-6 text-green-600 text-center border-b-2 p-2"
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          <h2 className="text-xl font-bold mb-4 text-green-600">Age Plot</h2>
          <img
            src={agePlot}
        ...
        <motion.div
          ...
          className="bg-gray-100 p-4 rounded-lg shadow-md"
        >
          <h2 className="text-xl font-bold mb-4 text-green-600">BMI Plot</h2>
          <img
            src={BMIPlot}
            alt="BMI vs Age"
            className="mx-auto w-full h-64 object-cover rounded-lg cursor-pointer"
        ...
        <motion.div
          ...
          className="bg-gray-100 p-4 rounded-lg shadow-md"
        >
          <h2 className="text-xl font-bold mb-4 text-green-600">Skin Plot</h2>
          <img
            src={skin}
            alt="Residual Plot"
            className="mx-auto w-full h-64 object-cover rounded-lg cursor-pointer"
